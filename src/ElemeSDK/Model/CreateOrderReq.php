...
class CreateOrderReq
{
     ...
     */
    private $receiver_primary_phone;
    /**
     * @var string 收货人备用联系方式
     */
    private $receiver_second_phone;
    /**
     * @var string 分机号
     */
    private $customer_ext_tel;
    /**
     * @var string 用户备注
     */
     ...
     * @var string 预询后下单标识
     */
    private $pre_create_order_t_index_id;
    /**
     * @var string 优惠券id
     */
     ...
     */
    private $actual_delivery_amount_cent;
    /**
     * @var string 核销码（贵品服务必填）
     */
    private $write_off_code;
    /**
